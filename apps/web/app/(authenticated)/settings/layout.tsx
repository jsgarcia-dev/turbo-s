    ...
    <div className="flex min-h-screen flex-col">
      ...
      <div className="mx-auto w-full max-w-7xl">
        ...
        <div className="sticky top-0 z-40 md:hidden">
          <div className="bg-background/95 supports-[backdrop-filter]:bg-background/60 border-border/40 flex items-center gap-3 border-b px-4 py-3 backdrop-blur">
            <Sheet>
              ...
              <SheetContent
                side="left"
                className="w-[80%] max-w-[280px] border-none p-0"
              >
                <div className="bg-primary text-primary-foreground p-4">
                  <SheetTitle className="text-primary-foreground text-sm font-medium">
                    Configurações da conta e perfil
                  </SheetTitle>
                </div>
